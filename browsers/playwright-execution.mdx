...
**For complex workloads, Kernel has a full [code execution platform](/apps)** - but this is the fastest way to execute code on a browser.
...
console.log(response.result); // "Example Page Title"
```
...
print(response.result)  # "Example Page Title"
```
