...
Kernel browsers were designed to be lightweight, fast, and efficient for cloud-based browser automations at scale. They can be used as part of the Kernel [app platform](/build/develop) or connected to from another service with the Chrome DevTools Protocol.
...
You can also delete the browser by [specifiying a timeout](/launch/browser-termination#timeouts-for-non-persisted-browsers) when you create the browser.
w
## Full example
