...
Non-persistent browsers automatically delete after a timeout (default 60 seconds) if they don't receive a CDP or live view connection. You can [configure this timeout](/browsers/termination#timeouts-for-non-persisted-browsers) when creating the browser.
