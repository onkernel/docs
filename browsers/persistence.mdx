...
<Warning>
New browser features and API endpoints are only available on newly created browser instances. If you have a persistent browser that was created before a feature was released, you must [delete the browser](/browsers/termination) and create a new one to access the new functionality.
</Warning>
