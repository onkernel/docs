...
Under the hood, our browsers are optimized for realistic environments. Everything we do is open source and inspectable — you can view our build configurations and runtime layers [here](github.com/onkernel/kernel-images).
...
### [Configurable Proxies](/browsers/bot-detection/proxies/overview)
...
| **Extensions** | Use the [Extensions API](/docs/browsers/extensions) carefully — each adds its own fingerprint, which can be detected. |
