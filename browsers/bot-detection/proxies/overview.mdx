...
1. [**Datacenter**](/browsers/bot-detection/proxies/datacenter) - Traffic routed through commercial data centers
2. [**ISP**](/browsers/bot-detection/proxies/isp) - Traffic routed through data centers, using residential IP addresses leased from from internet service providers
3. [**Residential**](/browsers/bot-detection/proxies/residential) - Traffic routed through real residential IP addresses
4. [**Custom**](/browsers/bot-detection/proxies/custom) - Your own proxy servers
