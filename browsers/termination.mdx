...
await kernel.browsers.deleteByPersistenceID('unique-browser-id-for-persistence');
```
...
kernel = Kernel()
kernel.browsers.delete_by_persistence_id("unique-browser-id-for-persistence")
```
</CodeGroup>
