...
// Stop the recording
await kernel.browsers.replays.stop(kernelBrowser.session_id, replay.replay_id);
...
# Stop the recording
client.browsers.replays.stop(kernel_browser.session_id, replay.replay_id)
...
// ... perform some automation ...
await kernel.browsers.replays.stop(kernelBrowser.session_id, replay1.replay_id);

// Second recording
const replay2 = await kernel.browsers.replays.start(kernelBrowser.session_id);
// ... perform different automation ...
await kernel.browsers.replays.stop(kernelBrowser.session_id, replay2.replay_id);
```
...
# ... perform some automation ...
client.browsers.replays.stop(kernel_browser.session_id, replay1.replay_id)

# Second recording
replay2 = client.browsers.replays.start(kernel_browser.session_id)
# ... perform different automation ...
client.browsers.replays.stop(kernel_browser.session_id, replay2.replay_id)
```
</CodeGroup>
