...
<Card title="How It Works" icon="gear" href="/auth/agent/how-it-works">
  Learn what happens under the hood—how login pages are discovered, why re-auth is deterministic, and how sessions are monitored.
</Card>
