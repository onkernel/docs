...
This quickstart guide will help you deploy and invoke your first browser automation on Kernel. You'll launch a simple app using Playwright, Computer Use, or a web agent framework like Browser Use.

<Info>
    If you're looking to quickly swap your existing browser provider with Kernel browsers, follow the instructions [here](/build/remote-browsers).
</Info>
...
- A [Kernel account](https://dashboard.onkernel.com)
