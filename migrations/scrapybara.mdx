...
| **Proxy Support** | ❌ Not available | Create [Proxy](/browsers/bot-detection/proxies/overview#1-create-a-proxy). Then create browser with `kernel.browsers.create(proxy_id=proxy.id)` |
