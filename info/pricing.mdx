...
| Auth agents (authenticated) | N/A | 5 | 20 | Custom |

> Note: Limits are org-wide by default unless stated otherwise. Auth agent limits only count successfully authenticated agents—failed or in-progress attempts don't count toward your limit.
