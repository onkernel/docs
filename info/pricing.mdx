...
| Live auth connections | N/A | 5 | 20 | Custom |

> Note: Limits are org-wide by default unless stated otherwise. `Live auth connections` refer to the number of successful auth connections that Kernel maintains using your stored [Credentials](/auth/credentials) or [1Password connection](/integrations/1password).
