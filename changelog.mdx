...
- Added new [Claude Agent SDK templates](https://github.com/kernel/cli) for TypeScript and Python that demonstrate browser automation using Kernel's Playwright execution API.
