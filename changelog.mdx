...
- We created new [Typescript](https://github.com/kernel/cli/tree/main/pkg/templates/typescript/yutori-computer-use) and [Python](https://github.com/kernel/cli/tree/main/pkg/templates/python/yutori-computer-use) CLI templates for Yutori's [n1](https://docs.yutori.com/reference/n1) computer use model, so you can build browser agents with Yutori's pixels-to-actions LLM.
