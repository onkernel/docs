...
{
  "dependencies": {
    "@onkernel/sdk": "https://pkg.stainless.com/s/kernel-typescript/5cc0e0e48c515f5c6c88c8040442e095795b931f/dist.tar.gz"
  }
}
```
...
```
kernel @ https://pkg.stainless.com/s/kernel-python/0b2f621cd651357f8659a85eea24ac1e85d86fae/kernel-0.24.0-py3-none-any.whl
```
