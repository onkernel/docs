...
1. Go to the [Deploy Button generator](https://app.kernel.sh/deploy-button) in the Kernel dashboard
...
```markdown
[![Deploy to Kernel](https://app.kernel.sh/button.svg)](https://app.kernel.sh/deploy?repo=https://github.com/your-org/your-repo)
```

Or use HTML:

```html
<a href="https://app.kernel.sh/deploy?repo=https://github.com/your-org/your-repo">
  <img src="https://app.kernel.sh/button.svg" alt="Deploy to Kernel" />
</a>
```
