...
```markdown
[![Deploy to Kernel](https://dashboard.onkernel.com/button.svg)](https://dashboard.onkernel.com/deploy?repo=https://github.com/your-org/your-repo)
```

Or use HTML:

```html
<a href="https://dashboard.onkernel.com/deploy?repo=https://github.com/your-org/your-repo">
  <img src="https://dashboard.onkernel.com/button.svg" alt="Deploy to Kernel" />
</a>
```
