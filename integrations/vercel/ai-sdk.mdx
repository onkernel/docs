...
export const maxDuration = 300; // Next.js API route timeout
```
...
### 5. Use Live View for Debugging

Enable live view to watch the browser in real-time:
...
Ensure the browser session is still active before executing tasks:
