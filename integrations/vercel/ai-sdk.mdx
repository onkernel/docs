---
title: "AI SDK Tool"
description: "Build AI Agents with Kernel powered browser automation capabilities"
---
...
1. **Kernel API Key** - Obtain from the [Kernel Dashboard](https://dashboard.onkernel.com) or the [Vercel Marketplace integration](/integrations/vercel/marketplace)
