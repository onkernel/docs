...
| Flag | Description |
|------|-------------|
| `--persistence-id <persistence-id>` | Reuse state across launches with a persistence ID. |
...
### `kernel browsers delete <session-id or persistence-id>`
...
### `kernel browsers view <session-id or persistence-id>`
Return a live view URL for remote monitoring and control.

## Browser logs

### `kernel browsers logs stream <session-id or persistence-id>`
...
### `kernel browsers replays list <session-id or persistence-id>`
List replay recordings for a browser session.

### `kernel browsers replays start <session-id or persistence-id>`
...
### `kernel browsers replays stop <session-id or persistence-id> <replay-id>`
Stop an active replay recording.

### `kernel browsers replays download <session-id or persistence-id> <replay-id>`
...
### `kernel browsers process exec <session-id or persistence-id> [--] [command...]`
...
### `kernel browsers process spawn <session-id or persistence-id> [--] [command...]`
...
### `kernel browsers process kill <session-id or persistence-id> <process-id>`
...
### `kernel browsers process status <session-id or persistence-id> <process-id>`
Check process status information.

### `kernel browsers process stdin <session-id or persistence-id> <process-id>`
...
### `kernel browsers process stdout-stream <session-id or persistence-id> <process-id>`
Stream stdout and stderr from a process.

## Filesystem

### `kernel browsers fs new-directory <session-id or persistence-id>`
...
### `kernel browsers fs delete-directory <session-id or persistence-id>`
Delete a directory.
...
### `kernel browsers fs delete-file <session-id or persistence-id>`
Delete a file.
...
### `kernel browsers fs download-dir-zip <session-id or persistence-id>`
...
### `kernel browsers fs file-info <session-id or persistence-id>`
...
### `kernel browsers fs list-files <session-id or persistence-id>`
...
### `kernel browsers fs move <session-id or persistence-id>`
...
### `kernel browsers fs read-file <session-id or persistence-id>`
...
### `kernel browsers fs set-permissions <session-id or persistence-id>`
...
### `kernel browsers fs upload <session-id or persistence-id>`
...
### `kernel browsers fs upload-zip <session-id or persistence-id>`
...
### `kernel browsers fs write-file <session-id or persistence-id>`
...
### `kernel browsers computer click-mouse <session-id or persistence-id>`
...
### `kernel browsers computer move-mouse <session-id or persistence-id>`
...
### `kernel browsers computer screenshot <session-id or persistence-id>`
...
### `kernel browsers computer type <session-id or persistence-id>`
...
### `kernel browsers computer press-key <session-id or persistence-id>`
...
### `kernel browsers computer scroll <session-id or persistence-id>`
...
### `kernel browsers computer drag-mouse <session-id or persistence-id>`
...
### `kernel browsers playwright execute <session-id or persistence-id> [code]`
...
### `kernel browsers extensions upload <session-id or persistence-id> <extension-path>...`
