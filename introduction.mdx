...
<Info>
Install the Kernel SDK with `npm install @onkernel/sdk` or `pip install kernel`

**Latest SDK versions:** [![npm version](https://img.shields.io/npm/v/@onkernel/sdk)](https://www.npmjs.com/package/@onkernel/sdk) [![PyPI version](https://img.shields.io/pypi/v/kernel)](https://pypi.org/project/kernel/)
</Info>
